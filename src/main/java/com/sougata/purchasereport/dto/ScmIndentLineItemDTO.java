...
public class ScmIndentLineItemDTO implements Serializable {
    ...
    private ScmIndentHdrDTO scmindenthdr;
    ...
    public ScmIndentHdrDTO getScmIndentHdr() {
        return scmindenthdr;
    }

    public void setScmIndentHdr(ScmIndentHdrDTO scmindenthdr) {
